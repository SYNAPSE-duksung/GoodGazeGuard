...
# streamlit_demo만 따로 받아도 돌아가도록, streamlit_demo/model/ 안의 복사본을
# 우선 찾고, 없으면(예전 구조) ../branch1/dataset/ 쪽 원본을 대신 씀.
_LOCAL_MODEL_PATH = BASE_DIR / "model" / "branch1_lightgbm_personalized.txt"
_BRANCH1_MODEL_PATH = BASE_DIR.parent / "branch1" / "dataset" / "branch1_lightgbm_personalized.txt"
MODEL_PATH = _LOCAL_MODEL_PATH if _LOCAL_MODEL_PATH.exists() else _BRANCH1_MODEL_PATH
